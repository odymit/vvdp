...
class VulList(Base):
    ...
    av = Column(VARCHAR(1), nullable=False)
    ac = Column(VARCHAR(1), nullable=False)
    pr = Column(VARCHAR(1), nullable=False)
    ui = Column(VARCHAR(1), nullable=False)
    c  = Column(VARCHAR(1), nullable=False)
    i  = Column(VARCHAR(1), nullable=False)
    a  = Column(VARCHAR(1), nullable=False)
    p  = Column(VARCHAR(1), nullable=False)
    e  = Column(VARCHAR(1), nullable=False)
    f  = Column(VARCHAR(1), nullable=False)
    hi = Column(VARCHAR(1), nullable=False)
