...
class VulList(Base):
    ...
    attack_vector = Column(VARCHAR(8), nullable=False)
    attack_complexity = Column(VARCHAR(8), nullable=False)
    priviledge_required = Column(VARCHAR(8), nullable=False)
    user_interaction = Column(VARCHAR(8), nullable=False)
    confidential  = Column(VARCHAR(8), nullable=False)
    integration  = Column(VARCHAR(8), nullable=False)
    available  = Column(VARCHAR(8), nullable=False)
    privacy  = Column(VARCHAR(8), nullable=False)
    ecnomic  = Column(VARCHAR(8), nullable=False)
    functional  = Column(VARCHAR(8), nullable=False)
    human_safety = Column(VARCHAR(8), nullable=False)
    scope = Column(VARCHAR(8), nullable=False)
